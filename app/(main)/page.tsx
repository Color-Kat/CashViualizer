...
export const metadata: Metadata = {
    ...
    keywords: "Сколько это в наличке?, Как выглядит миллион, визуализатор налички, Cash Visualizer, наличные деньги, вес денег, размер стопки денег, зарядка денежной энергией, калькулятор налички, калькулятор банкнот, калькулятор денег, калькулятор наличности",
